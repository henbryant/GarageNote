# Navigation Specification (React Navigation)
...
- `RootNavigator`
  - `MainTabs`
  - `Detail/Create/Edit Screens`（Stackで管理）
...
- `FuelLogEditScreen`
- `MaintenanceLogDetailScreen`
- `MaintenanceLogCreateScreen`
- `MaintenanceLogEditScreen`
- `ExpirationEditScreen`（`type` を渡して編集）
